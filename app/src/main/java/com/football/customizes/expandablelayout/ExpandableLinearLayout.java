...
public class ExpandableLinearLayout extends LinearLayout implements ExpandableLayout {
    ...
    private void init(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.ExpandableLinearLayout, defStyleAttr, 0);
        duration = a.getInteger(R.styleable.ExpandableLinearLayout_ael_duration, DEFAULT_DURATION);
        defaultExpanded = a.getBoolean(R.styleable.ExpandableLinearLayout_ael_expanded, DEFAULT_EXPANDED);
        defaultChildIndex = a.getInteger(R.styleable.ExpandableLinearLayout_ael_defaultChildIndex,
                Integer.MAX_VALUE);
        defaultPosition = a.getDimensionPixelSize(R.styleable.ExpandableLinearLayout_ael_defaultPosition,
                Integer.MIN_VALUE);
        final int interpolatorType = a.getInteger(R.styleable.ExpandableLinearLayout_ael_interpolator,
