package com.football.customizes.expandablelayout;
...
public class ExpandableRelativeLayout extends RelativeLayout implements ExpandableLayout {
    ...
    private void init(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        duration = a.getInteger(R.styleable.ExpandableRelativeLayout_ael_duration, DEFAULT_DURATION);
        defaultExpanded = a.getBoolean(R.styleable.ExpandableRelativeLayout_ael_expanded, DEFAULT_EXPANDED);
        orientation = a.getInteger(R.styleable.ExpandableRelativeLayout_ael_orientation, VERTICAL);
        defaultChildIndex = a.getInteger(R.styleable.ExpandableRelativeLayout_ael_defaultChildIndex,
                Integer.MAX_VALUE);
        defaultPosition = a.getDimensionPixelSize(R.styleable.ExpandableRelativeLayout_ael_defaultPosition,
                Integer.MIN_VALUE);
        final int interpolatorType = a.getInteger(R.styleable.ExpandableRelativeLayout_ael_interpolator,
