...
public class ExpandableWeightLayout extends RelativeLayout implements ExpandableLayout {
    ...
    private void init(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.ExpandableWeightLayout, defStyleAttr, 0);
        duration = a.getInteger(R.styleable.ExpandableWeightLayout_ael_duration, DEFAULT_DURATION);
        defaultExpanded = a.getBoolean(R.styleable.ExpandableWeightLayout_ael_expanded, DEFAULT_EXPANDED);
        final int interpolatorType = a.getInteger(R.styleable.ExpandableWeightLayout_ael_interpolator,
